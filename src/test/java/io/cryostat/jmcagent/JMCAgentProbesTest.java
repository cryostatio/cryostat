...
public class JMCAgentProbesTest extends AgentTestBase {
    ...
    void uploadProbeTemplate() {
        given().log()
                ...
                .post("/api/v5/jmc-agent/probe-templates")
                .then()
                .assertThat()
                .statusCode(201);
    }
    ...
    void cleanupProbeTemplate() {
        given().log()
                .all()
                .when()
                .delete("/api/v5/jmc-agent/probe-templates/" + PROBE_TEMPLATE_NAME)
                .then()
                .assertThat()
        ...
        MatcherAssert.assertThat(
                (List<?>)
                        given().log()
                                ...
                                .when()
                                .get("/api/v5/targets/{jvmId}/jmc-agent/probes")
                                .then()
                                .log()
                                .all()
                                .and()
    ...
    void testInsertAndRemoveProbes() {
        given().log()
                ...
                .when()
                .post("/api/v5/targets/{jvmId}/jmc-agent/probes/{probeTemplateName}")
                .then()
                .log()
                .all()
                .and()
        ...
        given().log()
                ...
                .pathParams("jvmId", target.jvmId())
                .when()
                .delete("/api/v5/targets/{jvmId}/jmc-agent/probes")
                .then()
                .log()
                .all()
                .and()
