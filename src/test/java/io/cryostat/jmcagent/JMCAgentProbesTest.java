...
public class JMCAgentProbesTest extends AgentTestBase {
    ...
    void uploadProbeTemplate() {
        given().log()
                ...
                .post("/api/v5/jmc_agent/probe_templates")
                .then()
                .assertThat()
                .statusCode(201);
    }
    ...
    void cleanupProbeTemplate() {
        given().log()
                .all()
                .when()
                .delete("/api/v5/jmc_agent/probe_templates/" + PROBE_TEMPLATE_NAME)
                .then()
                .assertThat()
        ...
        MatcherAssert.assertThat(
                (List<?>)
                        given().log()
                                ...
                                .when()
                                .get("/api/v5/targets/{jvmId}/jmc_agent/probes")
                                .then()
                                .log()
                                .all()
                                .and()
    ...
    void testInsertAndRemoveProbes() {
        given().log()
                .all()
                .pathParams("jvmId", target.jvmId(), "probeTemplateName", PROBE_TEMPLATE_NAME)
                .when()
                .post("/api/v5/targets/{jvmId}/jmc_agent/probes/{probeTemplateName}")
                .then()
                .log()
                .all()
                .and()
        ...
        given().log()
                ...
                .pathParams("jvmId", target.jvmId())
                .when()
                .delete("/api/v5/targets/{jvmId}/jmc_agent/probes")
                .then()
                .log()
                .all()
                .and()
    ...
    void testInsertProbesWithNonExistentTemplate() {
        given().log()
                .all()
                .pathParams("jvmId", target.jvmId(), "probeTemplateName", "nonexistent")
                .when()
                .post("/api/v5/targets/{jvmId}/jmc_agent/probes/{probeTemplateName}")
                .then()
                .log()
