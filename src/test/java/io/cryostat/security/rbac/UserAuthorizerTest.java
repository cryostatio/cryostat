...
@QuarkusTest
@TestProfile(UserAuthorizerTest.PermissiveProfile.class)
class UserAuthorizerTest {

    public static class PermissiveProfile implements QuarkusTestProfile {
        @Override
        public Map<String, String> getConfigOverrides() {
            return Map.of("cryostat.security.rbac.mode", "PERMISSIVE");
        }
    }
    ...
    @Test
    void permissiveModeSkipsCheck() {
        assertDoesNotThrow(() -> authorizer.assertAuthorized("credentials", "write"));
        verify(securityIdentity, never()).checkPermission(any(Permission.class));
    }
}
