...
/** A zero maximum size disables caching: every call gets a fresh client, closed after use. */
@QuarkusTest
@TestProfile(SsarClientCacheDisabledBySizeTest.Profile.class)
class SsarClientCacheDisabledBySizeTest {

    public static class Profile implements QuarkusTestProfile {
        @Override
        public Map<String, String> getConfigOverrides() {
            return Map.of("cryostat.security.rbac.cache.maximum-size", "0");
        }
    }
    ...
    void testClientIsUsableWithinCallbackAndClosedAfter() {
        ...
        assertSame(mockClient, seen);
        verify(mockClient).close();
    }

    @Test
    void testEachCallCreatesANewClient() {
        ...
        assertSame(first, cache.withClient("tok", c -> c));
