...
public class RuleService {
    ...
    @Blocking
    public void consumeEvent(Rule rule) {
        logger.trace("RuleService.consumeEvent called with Rule entity: " + rule.name);
                ...
                connectionManager.executeConnectedTask(
                        ...
                        connection -> {
                            Optional<IRecordingDescriptor> previous =
                                    RecordingHelper.getDescriptorByName(connection, recordingName);
